...
.![Родословно дърво](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\Tree.png)
...
![Автозомно Доминантно](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\AD.png)
...
* **Мозаицизъм:** Присъствие в един индивид или в една тъкан на ≥ 2 клетъчни линии, които произлизат от една зигота.
    ...
    * **Соматичен мозаицизъм:** Генна мутация, настъпила рано в ембриогенезата.
    ...
    ![Непълна пенентрантност](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\Непълна пенетрантност.png)
...
![Автозомно рецесивно унаследяване](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\Автозомно рецесивно унаследяване.png)
...
* **Алелна хетерогенност:** Различни мутации в даден локус са причина за появата на дадено състояние.
    ...
    * **Компаунд хетерозигот:** Индивид, при който са идентифицирани две различни мутации в един и същи локус: A**a1** x Aa2 -> **a1a2**
    ...
    ![Алелна и локусна хетерогенност](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\Алелна и локусна хетерогенност.png)
...
![X–доминантно унаследяване](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\X–доминантно унаследяване.png)
...
* **Болен баща** има най-често **здраво потомство**:
    ...
    * Синовете са фено- и генотипно **здрави**.
    ...
    ![X – рецесивно унаследяване](D:\Filen\Personal\Website\files\Клинична Генетика\Упражнения\assets\X – рецесивно унаследяване.png)
