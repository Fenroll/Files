...
#### Епидемиология
В **Европейския съюз** се отчита висока годишна заболеваемост и смъртност:

* **Недребноклетъчен белодробен карцином (НДК):**
    * Заболеваемост: до **80.0/100 000** (мъже) и до **39.0/100 000** (жени).
    * Смъртност: **48.7/100 000** (два пола).
* **Дребноклетъчен белодробен карцином (ДКК):**
    * Заболеваемост: **75.3/100 000** (мъже) и **18.3/100 000** (жени).
    * Смъртност: **64.8/100 000** (мъже) и **15.1/100 000** (жени).

По данни на **СЗО**, карциномът на трахеята, бронхите и белите дробове е **водеща причина за смърт** в Европейския регион с **0.38 милиона случая годишно** (3.9% от общата смъртност).
...
* **Генни мутации:**
    ...
    * Други гени: с-МЕТ, NKX2-1, LKB1, PIK3CA и BRAF.
...
#### Хистологична класификация по СЗО
...
* **Други и некласифицирани карциноми**
...
* **Аденокарцином:**
    * **Не е задължително свързан** с тютюнопушенето. Развива се от алвеоларните и бронхиоларните жлезни клетки.
    * Локализира се типично като **периферно разположена маса**.
    * Той е първичен белодробен или вторичен от други места, особено когато е налице инфилтрация на плеврата и последващ плеврален излив.
...
* Нелекуваният ДКК има средна преживяемост от **6 седмици**.
...
* **Tx:** Първичният тумор не може да се оцени или тумор, доказан с наличие на туморни клетки в храчка или бронхиален съмв при негативни образни изследвания и бронхоскопия.
...
* **Дисфагия**.
* **Плеврален излив** (поради директна инвазия на тумора или плеврални метастази).
* Вдигнат високо диафрагмален купол на пулмография (при парализа на n.phrenicus).
* **Синдром на Claude Bernard-Homer** (<u>птоза на клепача, миоза, енофталм</u>) в резултат на ангажиране на шийната част на n.sympaticus от върхов или Pancoast-Tobias тумор.
...
* Увеличен черен дроб.
* Болки/патологични фрактури на костите в резултат на костни метастази.
* Общомозъчна симптоматика или огнищна неврологична симптоматика при мозъчни метастази.
...
**Паранеобластични синдроми **(от продукцията на хормонподобни субстанции)**:**
