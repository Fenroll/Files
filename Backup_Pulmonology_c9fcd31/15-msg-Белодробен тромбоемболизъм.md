...
**Най-честите транзиторни или обратими рискови фактори за БТЕ са:** <u>напреднала възраст, продължителна имобилизация, операции, фрактури, тъканни травми, използване на естрогени, бременност, ХОББ, тютюнопушене и продължително пътуване</u>.
